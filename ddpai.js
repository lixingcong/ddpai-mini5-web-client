 ...
 * @return {null|array} 当errcode字段为0时，返回data字段下的内容，否则返回null
 */
 ...
 */
function gpxToPathArray(gpxFileContent, maxLineCount, newline) {
    var ret = {};
...
console.log(gpxToPathArray(testGpxFileContent, 6, '\n'));
test gpx file */
/* for test only 2 */