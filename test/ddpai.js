...
console.log(testTimeSpan);
console.log(DDPAI.mergeIntervals(testTimeSpan));
...
console.log(DDPAI.API_GpsFileListReqToArray(testInputJson));

console.log('dddmmToDecimal:');
let testDDDmm=['12345.6789', '2345.6789', '345.6789', '045.6789', '12345.0'];
testDDDmm.forEach(dddmm => {console.log(DDPAI.dddmmToDecimal(dddmm))});
...
console.log('preprocessRawGpxFile:');
const preprocessed = DDPAI.preprocessRawGpxFile(testGpxFileContent, 100, '\n');
console.log(preprocessed);

console.log('gpxToWayPointDict:');
const waypoints = DDPAI.gpxToWayPointDict(preprocessed.content);
